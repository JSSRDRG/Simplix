...
class Tab {
  ...
  static close (id) {
    ...
    if (Tab.list.length === 1) mainWindow.close()
...
function setEvents (id) {
  ...
  $(`#view${id}`).addEventListener('load-commit', () => {
    console.log(event.type)
  })
  $(`#view${id}`).addEventListener('did-finish-load', () => {
    console.log(event.type)
  })
  $(`#view${id}`).addEventListener('did-fail-load', () => {
    console.log(event.type)
  })
  $(`#view${id}`).addEventListener('did-frame-finish-load', () => {
    console.log(event.type)
  })
  ...
  $(`#view${id}`).addEventListener('dom-ready', () => {
    console.log(event.type)
  })
  $(`#view${id}`).addEventListener('page-title-updated', () => {
    console.log(event.type)
  })
  $(`#view${id}`).addEventListener('page-favicon-updated', () => {
    console.log(event.type)
  })
  $(`#view${id}`).addEventListener('enter-html-full-screen', () => {
    console.log(event.type)
  ...
  $(`#view${id}`).addEventListener('console-message', () => {
    console.log(event.type)
    console.log(`[LOG] ${event.message}`)
  })
  $(`#view${id}`).addEventListener('new-window', () => {
    console.log(event.type)
  })
  $(`#view${id}`).addEventListener('will-navigate', () => {
    console.log(event.type)
  })
  $(`#view${id}`).addEventListener('did-navigate', () => {
    console.log(event.type)
  })
  $(`#view${id}`).addEventListener('did-navigate-in-page', () => {
    console.log(event.type)
  })
  $(`#view${id}`).addEventListener('close', () => {
    console.log(event.type)
  })
  $(`#view${id}`).addEventListener('ipc-message', () => {
    console.log(event.type)
  })
  $(`#view${id}`).addEventListener('crashed', () => {
    console.log(event.type)
  })
  $(`#view${id}`).addEventListener('gpu-crashed', () => {
    console.log(event.type)
  })
  $(`#view${id}`).addEventListener('plugin-crashed', () => {
    console.log(event.type)
  })
  $(`#view${id}`).addEventListener('deystroyed', () => {
    console.log(event.type)
  })
  $(`#view${id}`).addEventListener('media-started-playing', () => {
    console.log(event.type)
  })
  $(`#view${id}`).addEventListener('media-paused', () => {
    console.log(event.type)
  })
  $(`#view${id}`).addEventListener('did-change-theme-color', () => {
    console.log(event.type)
  })
  $(`#view${id}`).addEventListener('update-target-url', () => {
    console.log(event.type)
  })
  $(`#view${id}`).addEventListener('devtools-opened', () => {
    console.log(event.type)
  })
  $(`#view${id}`).addEventListener('devtools-closed', () => {
    console.log(event.type)
  })
  $(`#view${id}`).addEventListener('devtools-focused', () => {
    console.log(event.type)
  })
}
