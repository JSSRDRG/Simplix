...
function buildWin () {
  appElement.classList.add('win32')
...
function buildDarwin () {
  appElement.classList.add('darwin')
  ...
  // Change window controls div size when in fullscreen.
  mainWindow.on('enter-full-screen', () => {
    $('#window-controls').classList.add('fullscreen')
  })
  mainWindow.on('leave-full-screen', () => {
    $('#window-controls').classList.remove('fullscreen')
  })
